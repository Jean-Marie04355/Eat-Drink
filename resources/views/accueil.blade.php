...
@section('content')
    <div class="container mt-5">
        <div class="text-center">
            ...
            <a href="{{ route('exposants.index') }}" class="btn btn-lg mt-3" style="background-color: #7b1e3d; color: white; border: none;">
               Nos exposants
            </a>
        </div>
        ...
        <div class="row text-center">
            <div class="col-md-4">
                <a href="{{ route('auth.inscription') }}"style="text-decoration: none;color: #7b1e3d;">
                    <h3>👨‍🍳 Entrepreneurs</h3>
                </a>
            ...
            <div class="col-md-4">
                <a href="{{ route('exposants.index') }}" style="text-decoration: none;color: #7b1e3d;">
                    <h3>👥 Visiteurs</h3>
                </a>
